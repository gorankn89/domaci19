...
public class ASCIIArtGenerator {
    ...
    protected void printTextArt(String artText, int textHeight, ASCIIArtFont fontType, String artSymbol) throws Exception {
     ...
     * @throws Exception
     */
    protected void printTextArt(String artText, int textHeight) throws Exception {
     ...
     * @return
     */
    protected int findImageWidth(int textHeight, String artText, String fontName) {
     ...
     * @return
     */
    protected int getBaselinePosition(Graphics g, Font font) {
